...
function LoginUser() {
  const registrynumber = "0000000"
  const businessName = "Icosa Gallery"
  const address = "-"
  const thirdpartyinfouse = "" //Information used by third parties
  return (
    <Container>
      <Row className="tacs">
        <Col>
          ...
          <p>
            ...
            privacy policy govern {businessName}’s relationship with you in
            ...
            {businessName}’ or ‘us’ or ‘we’ refers to the owner of the website
            whose registered office is {address}. Our company registration
            number is {registrynumber}. The term ‘you’ refers to the user or
          ...
          <ul>
            ...
            <li>
              ...
              may be stored by us for use by third parties: {thirdpartyinfouse}
            </li>
            <li>
